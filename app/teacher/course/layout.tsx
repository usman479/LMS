            ...
            <section>
                <div className="md:ml-[90px] mx-6 mb-4">
                    ...
                    <div className="border-2 border-t-2 border-t-black p-2 flex flex-wrap">
                        <Link href={{ pathname: "/teacher/course/lecture", query: { course_id, student_id,teacher_id } }} className='flex flex-grow'>
                            <button
                                className={`py-2 px-4 rounded-md shadow-lg m-4 text-center flex-grow ${activeButton === "lecture"
                                    ? "bg-black text-white"
                                    : "bg-slate-200"
                                    }`}
                            >
                        ...
                        <Link href={{ pathname: "/teacher/course/attendance", query: { course_id, teacher_id, student_id } }} className='flex flex-grow'>
                            <button
                        ...
                        <Link href={{ pathname: "/teacher/course/assignment", query: { course_id, teacher_id, student_id } }} className='flex flex-grow'>
                            <button
                        ...
                        <Link href={{ pathname: "/teacher/course/quiz", query: { course_id, teacher_id, student_id } }} className='flex flex-grow'>
                            <button
                        ...
                        <Link href={{ pathname: "/teacher/course/announcement", query: { course_id, student_id,teacher_id } }} className='flex flex-grow'>
                            <button
