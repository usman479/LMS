...
const Navigation = () => {
    ...
    return (
        <header className="flex items-center justify-between px-6 border-b-2 shadow-md sticky top-0 z-50 bg-white">
