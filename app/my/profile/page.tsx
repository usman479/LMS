...
export default function ProfilePage() {
    ...
    useEffect(() => {
        if (status === 'authenticated') {
            const res = fetch(`http://localhost:3000/api/student_profile?s_id=${session?.user.s_id}`)
    ...
    if (user) {
        const src = user.s_image || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png";
        return (
            <>
