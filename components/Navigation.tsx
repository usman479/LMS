  ...
  return (
    <header className="flex items-center justify-between px-6 py-2 border-b-2 shadow-md sticky top-0 z-50 bg-white">
      <div className="flex items-center">
        ...
        <img
          src="https://lms.dsu.edu.pk/pluginfile.php/1/theme_moove/logo/1637580917/logo.png"
          className="h-16 ml-10 hidden md:block"
          alt="logo"
        />
        <div
          className={
            open
              ? `fixed left-0 top-[82px] w-20 md:w-64 h-full bg-white duration-500 shadow-2xl`
              : `fixed left-0 top-[82px] w-0 md:w-20 h-full bg-white duration-500 shadow-2xl`
          }
        >
          <ul>
            <li
              className={
                open
                  ? `flex items-center py-4 px-6 bg-white`
                  : `flex items-center justify-center py-4 px-2 bg-white`
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="flex items-center justify-between group">
        <img
          ...
          alt="profile_picture"
        />
        <div className="sm:min-w-0 absolute right-6 top-[75px]">
          <ul
            className="flex flex-col group-hover:border-2 border-gray-300 group-hover:max-h-max max-h-0 overflow-hidden 
                       duration-300 bg-white group-hover:shadow-md cursor-pointer"
          >
